...
void ASoldierGameState::RequestFinishAndExitToMainMenu()
{
	if (AuthorityGameMode)
	{
		...
		AOceanBoatsGameMode* const GameMode = Cast<AOceanBoatsGameMode>(AuthorityGameMode);
		if (GameMode)
		{
	...
	else
	{
		...
		UArmySimGameInstance* GameInstance = Cast<UArmySimGameInstance>(GetGameInstance());
		if (GameInstance)
		{
