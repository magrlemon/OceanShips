...
public:	
	...
	/** build menu */
	void Construct(TWeakObjectPtr<UArmySimGameInstance> _GameInstance, TWeakObjectPtr<ULocalPlayer> _PlayerOwner);
...
protected:
	...
	TWeakObjectPtr<UArmySimGameInstance> GameInstance;
	...
	/** if game main menu is currently opened*/
	bool bIsGameMainMenuUp;
	...
	TSharedPtr<class SArmySimConfirmationDialog> QuickMatchFailureWidget;
	...
	TSharedPtr<class SArmySimConfirmationDialog> QuickMatchSearchingWidget;
	...
	TSharedPtr<class SArmySimConfirmationDialog> QuickMatchStoppingWidget;
