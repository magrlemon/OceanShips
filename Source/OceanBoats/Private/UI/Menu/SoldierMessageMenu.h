...
class UArmySimGameInstance;

class FSoldierMessageMenu : public TSharedFromThis<FSoldierMessageMenu>
{
public:
	/** build menu */
	void Construct(TWeakObjectPtr<UArmySimGameInstance> InGameInstance, TWeakObjectPtr<ULocalPlayer> InPlayerOwner, const FText& Message, const FText& OKButtonText, const FText& CancelButtonText,  const FName& InPendingNextState);
