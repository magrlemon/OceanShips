...
{
	MenuStyle = &FArmySimStyle::Get().GetWidgetStyle<FSoldierMenuStyle>("DefaultSoldierMenuStyle");
	...
	const FSlateFontInfo PlayerNameFontInfo = FArmySimStyle::Get().GetWidgetStyle<FTextBlockStyle>("OceanBoats.MenuProfileNameStyle").Font;
	const FSlateFontInfo ProfileSwapFontInfo = FArmySimStyle::Get().GetWidgetStyle<FTextBlockStyle>("OceanBoats.MenuServerListTextStyle").Font;
	...
	[
		...
		[
			...
			[
				...
				[
					SNew(STextBlock)
					.TextStyle(FArmySimStyle::Get(), "OceanBoats.MenuProfileNameStyle")
...
bool SSoldierMenuWidget::ProfileUISwap(const int ControllerIndex) const
{
	if (IsProfileSwapActive())
	{
		...
		{
			UArmySimGameInstance* GameInstance = PlayerOwner.IsValid() ? Cast< UArmySimGameInstance >( PlayerOwner->GetGameInstance() ) : nullptr;
