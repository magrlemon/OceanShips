	...
	void Construct( const FArguments& InArgs )
	{
		...
		[
			...
			[ 
				...
				.Text(LOCTEXT("PressStartSwitch", "PRESS <img src=\"OceanBoats.Switch.Right\"/> TO PLAY"))
#else
				.Text( LOCTEXT("PressStartXboxOne", "PRESS A TO PLAY" ) )
#endif
				.TextStyle( FArmySimStyle::Get(), "OceanBoats.WelcomeScreen.WelcomeTextStyle" )
...
void FSoldierWelcomeMenu::Construct( TWeakObjectPtr< UArmySimGameInstance > InGameInstance )
{
