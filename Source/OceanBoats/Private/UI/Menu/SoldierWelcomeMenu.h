...
public:
	/** build menu */
	void Construct( TWeakObjectPtr< class UArmySimGameInstance > InGameInstance );
	...
	TWeakObjectPtr< class UArmySimGameInstance > GetGameInstance() { return GameInstance; }

private:
	/** Owning game instance */
	TWeakObjectPtr< class UArmySimGameInstance > GameInstance;
