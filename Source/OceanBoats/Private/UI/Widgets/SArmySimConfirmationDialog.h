...
class SArmySimConfirmationDialog : public SCompoundWidget
{
public:
	...
	EArmySimDialogType::Type DialogType;

	SLATE_BEGIN_ARGS( SArmySimConfirmationDialog )
	{}

	SLATE_ARGUMENT(TWeakObjectPtr<ULocalPlayer>, PlayerOwner)
	SLATE_ARGUMENT(EArmySimDialogType::Type, DialogType)
