...
//
//
//class FSimWelcomeMenu : public TSharedFromThis<FSimWelcomeMenu>
//{
//public:
//	/** build menu */
//	void Construct( TWeakObjectPtr< class USimGameInstance > InGameInstance );
//
...
//	}
//	TWeakObjectPtr< class USimGameInstance > GetGameInstance() { return GameInstance; }
//
//private:
//	/** Owning game instance */
//	TWeakObjectPtr< class USimGameInstance > GameInstance;
//
