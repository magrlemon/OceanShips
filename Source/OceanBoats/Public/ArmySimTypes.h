...
#include "ArmySimTypes.generated.h"
#pragma once

namespace ESimMatchState
{
	enum Type
	{
		Warmup,
...
namespace ESimCrosshairDirection
{
	enum Type
	{
		Left=0,
...
/** keep in sync with SimImpactEffect */
UENUM()
namespace ESimPhysMaterialType
{
	enum Type
	{
		Unknown,
